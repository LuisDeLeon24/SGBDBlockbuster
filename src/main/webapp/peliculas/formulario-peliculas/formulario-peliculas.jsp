...
<body>
    ...
    <div class="container mt-3 text-center">
        ...
        <div class="alert alert-success d-flex align-items-center" role="alert">
            ...
            <div>
                <h1>Pelicula En Cartelera Con Exito!</h1>
            </div>
        </div>
        <%}%>
        <%}%>
        ...
        <div class="container mt-3 form-container">
            <form action="/Blockbuster/pelicula-servlet" method="post" endtype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="marca" class="form-control" id="genero" name="genero" placeholder="genero">
                    <label for="floatingPassword">Genero De La Pelicula</label>
                </div>
                <div class="form-floating mb-3">
                    <textarea class="form-control" placeholder="Leave a comment here" id="estreno" name="estreno"></textarea>
                    <label for="floatingTextarea">Fecha De Estreno</label>
                </div>
                <div class="form-floating mb-3">
                    <textarea class="form-control" placeholder="Leave a comment here" id="director" name="director"></textarea>
