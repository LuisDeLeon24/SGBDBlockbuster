        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="" class="d-block w-100" alt="clienteone">
                </div>
                <div class="carousel-item">
                    <img src="" class="d-block w-100" alt="clientetwo">
                </div>
            </div>
