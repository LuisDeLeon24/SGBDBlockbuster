...
<html>
    ...
    <form class=" mt-3" action="/Blockbuster/EmpleadoServlet" method="post" enctype="multipart/from-data">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="nombreproducto" name="nombreEmpleado" placeholder="">
            <label for="nombreproducto">Nombre Del Empleado</label>
        </div>
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="marcaproducto" name="puestoEmpleado" placeholder="">
            <label for="marcaproducto">Puesto del Empleado</label>
        </div>
        ...
        <div class="form-floating mb-3">
            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="tiendaId" style="height: 100px"></textarea>
            <label for="floatingTextarea2">Sucursal Donde Trabaja</label>
        </div>
        <div>
