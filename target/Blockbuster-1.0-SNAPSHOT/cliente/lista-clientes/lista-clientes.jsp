            ...
            <form>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scopre="row"><%=cliente.getClienteId()%></th>
                            <th scopre="row"><%=cliente.getNombreCliente()%></th>
                            <th scopre="row"><%=cliente.getTelefono()%></th>
                            <th scopre="row"><%=cliente.getGeneroFavorito()%></th>
                            <th scopre="row"><%=cliente.getMembresiaId()%></th>
                        </tr>
                        <% }%>
                    </tbody>
                </table>
